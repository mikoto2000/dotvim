...
let a: u64 = FromStr::from_str(&line{{_input_:lineNumber}}[0]).unwrap();
let b: u64 = FromStr::from_str(&line{{_input_:lineNumber}}[1]).unwrap();
let c: u64 = FromStr::from_str(&line{{_input_:lineNumber}}[2]).unwrap();
