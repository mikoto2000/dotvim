...
function! m2h#M2H()
    ...
    " 出力先は出力用一時バッファ
    call job_start("pandoc --toc --toc-depth 4 -f markdown+pandoc_title_block-ascii_identifiers -t html5 --standalone --self-contained " . tempfile_in, {'out_io': 'file', 'out_name': tempfile_out, 'exit_cb': function("m2h#M2H_CB")})
endfunction
